	...
	<main class="main-content">
				...
				<div class="col-md-12 padd menu_wrp">
					...
					<?php 
						...
						while($row3 = mysqli_fetch_array($run3)){
							...
							$query4 = "SELECT * FROM sub_categories WHERE parent_id = '$cat_id3'";
							$run4   = mysqli_query($conn,$query4);
							if(mysqli_num_rows($run4)>=1){
								echo '<li class="toggle_item">'.$cat_name3.'  <i class="fa fa-caret-down" aria-hidden="true" id="careta"></i></li>';
							
								echo '<ul class="sub_cat_menu">';

									while($row4 = mysqli_fetch_array($run4)){
										$sub_id4   = $row4['id'];
										$sub_name4 = $row4['sub_category_name'];
										echo '<li><a href="shop.php?cate_id='.$sub_id4.'">'.$sub_name4.'</a></li>';
									}
								echo '</ul>';
							}else{
								echo '<li><a href="">'.$cat_name3.'</a></li>';
							}
						}
					?>
					</ul>
			...
			<div class="col-md-9">
				<?php
					...
					$query5 = "SELECT * FROM books WHERE trade = 1 ORDER BY id DESC LIMIT 30";
